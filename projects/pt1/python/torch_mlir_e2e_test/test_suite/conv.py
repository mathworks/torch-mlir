...
class TransposedConv2dWithCustomParams(torch.nn.Module):
    def __init__(self):
        super().__init__()
...
@register_test_case(module_factory=lambda: TransposedConv2dWithCustomParams())
def TransposedConv2dWithCustomParams_basic(module, tu: TestUtils):
